...
class EditForm extends React.Component {
  ...
  collectData(e) {
    ...
    const _this = this;
    axios.put(`https://localhost:5001/api/Entry/${this.props.entry.entryId}`, this.state.fields, config)
    .then(function (response) {
      console.log(response);
      _this.setState({ 
        successMessage: "Entry has been modified successfully. Please refresh contacts.",
        fields: {
          name: "",
          phone: ""
        }
    ...
    return(
      <div className="entry-form">
        ...
        <label>Name</label>
				...
				<input type="submit" value="EDIT" onClick={ this.collectData.bind(this) }/>
